CREATE TABLE IF NOT EXISTS user_data (
	...
	login varchar(100) NOT NULL CONSTRAINT valid_login CHECK (LENGTH(login) > 0),
	name varchar(100),
	birthday timestamp CONSTRAINT valid_birthday CHECK (birthday < CURRENT_TIMESTAMP)
);
...
CREATE TABLE IF NOT EXISTS film_data (
	...
	release_date timestamp CONSTRAINT valid_release_date CHECK (release_date > PARSEDATETIME('28.12.1895' , 'dd.MM.yyyy', 'en')),
	duration bigint CONSTRAINT valid_duration CHECK (duration > 0),
